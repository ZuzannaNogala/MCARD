...
# print(model_sklearn.predict(X_2d) - model.predict(X_2d))
...
model100D_params = model100D.get_params()

model_sklearn100D = LinearRegression()
model_sklearn100D.fit(X_100d, y_100d)

L2_norm = ((model_sklearn100D.intercept_ - model100D_params[0]) ** 2 +
           np.sum((model_sklearn100D.coef_ - model100D_params[1:]) ** 2))
